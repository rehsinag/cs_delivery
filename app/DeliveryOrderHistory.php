...
{
    protected $table = 'deliveryOrdersHistory';
    ...
    public function setDataFromArray($data)
    {
        ...
        if(isset($data['historyDate']) && trim($data['historyDate']))
            $this->historyDate = trim($data['historyDate']);
    ...
    public function submitData()
    {
        ...
        $deliveryOrder->historyDate = $this->historyDate;
